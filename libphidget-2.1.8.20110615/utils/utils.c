...
/* character escaping */
#define PASSTHRU(c) (isalnum((unsigned char)c)/* || c == ' '*/ || c == '.' || c == '/')
...
#endif
		//Make the socket non-blocking - not yet, this maybe is causing trouble on sbc1
//#ifndef _WINDOWS
...
//		}
//#else
//		if (ioctlsocket(fd, FIONBIO, (u_long FAR *) & nNonBlocking))
//		{
//			fd = INVALID_SOCKET;	
//			continue;
//		}
