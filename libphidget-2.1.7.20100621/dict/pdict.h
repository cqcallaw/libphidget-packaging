...
typedef void (*pdl_notify_func_t)(const char *k, const char *v,
    pdict_reason_t r, const char *pde_oldval, void *arg);
...
int pdict_add_persistent_change_listener(pdict_t *pd, const char *kpat,
    pdl_notify_func_t, void *);
...
int pdict_ent_add_change_listener(pdict_t *pd, const char *k,
    pdl_notify_func_t, void *);
int pdict_ent_remove_change_listener(pdict_t *pd, const char *k,
    pdl_notify_func_t, void *);
